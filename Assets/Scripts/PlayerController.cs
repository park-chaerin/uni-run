...
public class PlayerController : MonoBehaviour {
   ...
   private void Update() {
        ...
        {
            playerRigidbody.velocity = playerRigidbody.velocity * 0.5f; //마우스 왼쪽 버튼에서 순간 && 속도의 y값이 양수라면(위로 상승중) 현재 속도를 절반으로 설정
        }
   ...
   private void Die() {
        ...
        playerAudio.clip = deathClip; //오디오 소스에 할당된 오디오 클립을 deathClip로 변경
